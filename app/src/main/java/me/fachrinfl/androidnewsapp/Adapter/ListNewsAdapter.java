...
import me.fachrinfl.androidnewsapp.Common.ISO8601Parse;
import me.fachrinfl.androidnewsapp.DetailArticle;
...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsViewHolder> {
    ...
    public void onBindViewHolder(ListNewsViewHolder holder, int position) {
        ...
        String fontTime = "fonts/Ubuntu-Light.ttf";

        holder.article_title.setTypeface(Typeface.createFromAsset(context.getAssets(), fontTitle));
        holder.article_time.setTypeface(Typeface.createFromAsset(context.getAssets(), fontTime));
